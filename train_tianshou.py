...
def reward_param(name):
    if name == '1':
        return np.array([300.0, -0.48, -2.0, -200.0, 1.0, 1.0, -1.0, -2.0])
    elif name == '2':
        return np.array([300.0, -0.7, -2.0, -200.0, 1.0, 1.0, -1.0, -2.0])
    elif name == '3':
        return np.array([300.0, -0.9, -1.0, -200.0, 1.0, 1.0, -1.0, -2.0])
